    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="clasif.php"><h5>管理文章</h5></a> </li>
                <li><a href="textedit.php"><h5>写新文章</h5></a> </li>
                <li><a href="#"><h5>上传图片</h5></a> </li>
                <li><a href="#"><h5>发表心情</h5></a> </li>
            </ul>
        </div>
    </div>
...
<div class="sidebar">
    ...
    <div class="container" style="padding:10px">
        ...
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px;" onclick="location='pickmess.php'">私信</button>
            <button type="button" class="btn col-md-5" name="" onmouseover="this.style.backgroundColor='#9FA153';"
                    onmouseout="this.style.backgroundColor='#64605B';" style="background-color:#64605B;
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px" onclick="location='clasif.php'">分类</button>
            <button type="button" class="btn col-md-5" name="" onmouseover="this.style.backgroundColor='#9FA153';"
                    onmouseout="this.style.backgroundColor='#64605B';" style="background-color:#64605B;
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px">RSS</button>
            <button type="button" class="btn col-md-5" name="" onmouseover="this.style.backgroundColor='#9FA153';"
                    onmouseout="this.style.backgroundColor='#64605B';" style="background-color:#64605B;
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px" onclick="change();" >搜索</button>
        ...
        while($array=mysql_fetch_array($sign)){ ?>
            ...
            while($text=mysql_fetch_array($array1)) {
                ...
                <tr height=35px align='center'>
                    ...
                    <form action="textedit2.php" method="post">
                        <td align=center><font face="宋体" size=3 color="#555555"><b>
                                    <input type="hidden" name="textid" value=<?php echo $text[2]; ?>>
                                    <button class="btn btn-default" type="submit" style="margin-left:10px;height:30px"
                                            "><font
                                            style=\"color:#555555\">
                                            修改</font></button>
                                </b></font></td>
                ...
                <form action="delete.php" method="post">
                    <input type="hidden" name="textid" value=<?php echo $text[2]; ?>>
                    <td align=center><font face="宋体" size=3 color="#555555"><b>
                                <button class="btn btn-default" type="submit" style="margin-left:10px;height:30px"><font
                                        style=\"color:#555555\">
                                        删除</font></button>
                            </b></font></td>
                </tr>
