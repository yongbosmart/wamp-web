    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav" style="float: left">
                <li><h3 style="font-family: '微软雅黑 Light'">更新文章</h3></a> </li>
...
<form action="edit.php" method="post" name="wwte" id="wwte" role="form">
    <div class="panel panel-default  col-xs-8 col-md-offset-2 " style="margin-top:100px;margin-bottom:10px;border-radius:6px;padding: 40px 15px 50px 15px;overflow: auto;">
        <form class="panel-body">
            <?PHP if(isset($_POST['textid'])){echo "<input type=\"hidden\" name=\"textid\" value=".$_POST['textid'].">"; ?>
            <?PHP
            $id=$_POST['textid'];
            $sign=$admindb->ExecSQL
            ("select texthtml ,texttitle,sign1 from blogtext where textid = '$id'");
            $nei=mysql_fetch_array($sign);


            ?>
            <form class="" >
                <input type="text" class="form-control"  name="articletitle"
                       placeholder="请输入文章题目" id="texttitle" value="<?PHP echo $nei[1];?>">
    ...
    <div class="panel panel-default  col-xs-8 col-md-offset-2 " style="margin-top:10px;margin-bottom:100px;border-radius:6px;padding: 40px 15px 50px 15px;">
        <div class="panel-body">
            <form class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control"
                                   placeholder="请输入标签" id="texttag" name="texttag" value="<?PHP echo $nei[2];}?>">
                ...
                {echo ("<div class=\"alert alert-success\" role=\"alert\">");echo $_SESSION['success'];echo ("</div>");}$_SESSION['success']=null;?>
            </form>
