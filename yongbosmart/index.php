    ...
    <div class="container" style="padding:10px">
       ...
       <p></p>
        ...
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px;" onclick="location='pickmess.php'">私信</button>
             <button type="button" class="btn col-md-5" name="" onmouseover="this.style.backgroundColor='#9FA153';"
                     onmouseout="this.style.backgroundColor='#64605B';" style="background-color:#64605B;
        color:#ffffff;margin:10px;border-radius: 15px;height: 30px;width: 170px" onclick="window.location.href='clasif.php'">分类</button>
            <button type="button" class="btn col-md-5" name="" onmouseover="this.style.backgroundColor='#9FA153';"
                    onmouseout="this.style.backgroundColor='#64605B';" style="background-color:#64605B;
...
<!--                --><?php //echo("<input type=\"hidden\" name=\"textid\" value="+$myrow[4][$i]+">");?>
                <h5 align="right"><a href= <?php echo "read.php?textid=".$myrow[4][$i]?>>点击阅读全文 》》</a></h5>
            </div>
        </div>
